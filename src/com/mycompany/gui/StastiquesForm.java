...
public class StastiquesForm extends BaseForm {
      Form current;
private boolean drawOnMutableImage;

private double nbr_feedback =  45;
private double nbr_arbitre=29;
    public StastiquesForm(Resources res) {
        super("Newsfeed", BoxLayout.y());
        current=this;
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Statistiques des etats");
        ...
        addTab(swipe, res.getImage("news-item.jpg"), spacer1, "Bienvenu  ", "", "");
        ...
        RadioButton featured = RadioButton.createToggle("Liste des Commandes", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          ListArbForm b = new ListArbForm(res);
            b.show();
            refreshTheme();
        });
...
return render; 
    ...
    public void createPieChartForm(){
        double total = nbr_feedback + nbr_arbitre ;
        
        double prcntFeed =(nbr_feedback * 100)/total;
        double prcntRec = (nbr_arbitre * 100)/total;
    ...
    PieChart chart = new PieChart(buildDataset("title",Math.round(prcntFeed),Math.round(prcntRec)),render);
    
    ChartComponent c = new ChartComponent(chart);
    String[]messages ={ "Statistique etat"
   ...
   cnt.setUIID("Container");
    ...
    private CategorySeries buildDataset(String string, double prcntFeed, double prcntRec) {

        CategorySeries series = new CategorySeries(string);
         series.add("etat en cours",prcntRec);
                  series.add("etat validé ",prcntFeed);
